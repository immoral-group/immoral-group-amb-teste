export function initBottomPanel() {
    ...
    banner.innerHTML = `
        <div class="w-full max-w-2xl bg-[#0B0F14] text-white rounded-2xl shadow-2xl border border-[#2A2F36] p-4 sm:p-5 mb-4 sm:mb-6 flex flex-col xl:flex-row items-start xl:items-center gap-3 sm:gap-4">
