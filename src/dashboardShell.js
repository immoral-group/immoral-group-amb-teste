...
const ICONS = {
  ...
  qr: '<rect x="2.5" y="2.5" width="6" height="6" rx="1"/><rect x="11.5" y="2.5" width="6" height="6" rx="1"/><rect x="2.5" y="11.5" width="6" height="6" rx="1"/><rect x="12.5" y="12.5" width="2" height="2"/><rect x="15.5" y="12.5" width="2" height="2"/><rect x="12.5" y="15.5" width="2" height="2"/><rect x="15.5" y="15.5" width="2" height="2"/>',
};
  ...
  const navGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/qr-codes', label: 'Códigos QR', icon: 'qr' },
      ],
    },
    {
      label: 'Desarrollo',
