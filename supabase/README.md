...
16. `migrations/0017_partner_logos_clientes.sql` — reemplaza la barra de logos de la home (`partner_logos`): eran herramientas que usamos, pasan a ser las marcas de nuestros clientes.
